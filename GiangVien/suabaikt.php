        ...
        <head>
            ...
            <title>
                ...
                if ($lophoc != 0) {
                    ...
                    $tieude = $baikt['tieude']; $noidung = $baikt['noidung']; $thoigian = $baikt['thoigian'];
                    ...
                    ?>
                        <div class=""><br /> <br />
                            ...
                            <div class="d-flex justify-content-center align-items-center flex-column">
                                <form class="login" method="post" action="comp/suabaikt.php">
