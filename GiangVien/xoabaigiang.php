        ...
        <head>
            ...
            <title>
                ...
                if ($lophoc != 0) {
                    ...
                    $tieude = $baigiang['tieude']; $noidung = $baigiang['noidung'];
                    ...
                    ?>
                        <div class=""><br /> <br />
                            ...
                            <div class="d-flex justify-content-center align-items-center flex-column">
                                <form class="login" method="post" action="comp/xoabaigiang.php">
                                    <h3>XÓA BÀI GIẢNG?</h3>
                                    <?php
                                    // $err_stmt = $_GET['error'];
                                    ...
                                    <input name="idbg" style="visibility: hidden;" value="<?=$id_baigiang?>">
                                </form>
